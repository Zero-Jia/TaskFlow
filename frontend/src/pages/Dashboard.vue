<template>
          ...
          <div class="panel-grid">
            <div class="panel-card">
              ...
              <div class="bar-item">
                ...
                <div class="bar-track">
                  <div class="bar-fill" :style="{ width: getPercent(stats.status_counts.todo) + '%' }"></div>
                </div>
              </div>
              ...
              <div class="bar-item">
                ...
                <div class="bar-track">
                  <div class="bar-fill" :style="{ width: getPercent(stats.status_counts.in_progress) + '%' }"></div>
                </div>
              </div>
              ...
              <div class="bar-item">
                ...
                <div class="bar-track">
                  <div class="bar-fill" :style="{ width: getPercent(stats.status_counts.done) + '%' }"></div>
                </div>
              </div>
              ...
              <div class="bar-item">
                ...
                <div class="bar-track">
                  <div class="bar-fill" :style="{ width: getPercent(stats.status_counts.overdue) + '%' }"></div>
                </div>
              </div>
            </div>
            ...
            <div class="panel-card">
              ...
              <div class="bar-item">
                ...
                <div class="bar-track">
                  <div class="bar-fill green" :style="{ width: getPriorityPercent(stats.priority_counts.low) + '%' }"></div>
                </div>
              </div>
              ...
              <div class="bar-item">
                ...
                <div class="bar-track">
                  <div class="bar-fill yellow" :style="{ width: getPriorityPercent(stats.priority_counts.medium) + '%' }"></div>
                </div>
              </div>
              ...
              <div class="bar-item">
                ...
                <div class="bar-track">
                  <div class="bar-fill orange" :style="{ width: getPriorityPercent(stats.priority_counts.high) + '%' }"></div>
                </div>
              </div>
              ...
              <div class="bar-item">
                ...
                <div class="bar-track">
                  <div class="bar-fill red" :style="{ width: getPriorityPercent(stats.priority_counts.urgent) + '%' }"></div>
                </div>
              </div>
            </div>
          </div>
  ...
  async function loadStats() {
    try {
      ...
      errorMsg.value = error.response?.data?.message || '获取统计数据失败'
    } finally {
      loading.value = false
    }
  }
